          ...
          <div>
            ...
            <div className="space-y-8">
              <div className="flex items-start">
                ...
                <div>
                  ...
                  <p className="text-gray-600">
                    Pipli Chowk Maderna Colony behind Mandore, <br />
                    Krishi Mandi, Jodhpur, Rajsthan - 342007
                  </p>
                </div>
              </div>
              ...
              <div className="flex items-start">
                ...
                <div>
                  ...
                  <p className="text-gray-600">
                    <a href="mailto:support@avitoluxury.in" className="hover:text-black">support@avitoluxury.in</a>
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="mt-10">
              ...
              <div className="h-[300px] bg-gray-200 rounded-lg overflow-hidden">
                <iframe 
                  src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d14315.106662850472!2d72.98969716977538!3d26.31788999999999!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x39418c3910b0c801%3A0x450fe6c89bec5d06!2sKrishi%20Upaj%20Mandi%20Samiti!5e0!3m2!1sen!2sin!4v1685063289161!5m2!1sen!2sin" 
                  width="100%" 
                  height="100%" 
                  style={{ border: 0 }} 
                  allowFullScreen 
